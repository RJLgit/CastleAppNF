...
public class DummyData {
    public static ArrayList<Castles> generateAndReturnDataAZ(Context context) {
        ...
        rising = new Castles("Castle Rising", "Castle rising", 45, context.getString(R.string.rising_History), risPics, R.raw.canon_in_d, 0.4704, 52.7981, "http://www.castlerising.co.uk/", "http://www.castlerising.co.uk/visit-us/");
